...
def setup_arguments(args=None):
    ...
    parser.add_argument(
        ...
        help="Comma-separated experiment names used for lambda sweep.",
    )
    ...
    parser.add_argument(
        "--plot_path",
        type=str,
        default=os.path.join(get_hw2_root(), "section5_lunar_lambda_sweep.png"),
    )
...
def main(args):
    ...
    plt.title("LunarLander-v2 Section 5: GAE Lambda Sweep")
    plt.grid(alpha=0.3)
    plt.legend()
    plt.tight_layout()
